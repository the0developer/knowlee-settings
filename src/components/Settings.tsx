...
const Action = styled.b`
  ...
  width: 400px;
`;
const YouCanSpecify = styled.div`
  position: relative;
  font-size: var(--body-sm-medium-size);
  line-height: 20px;
  color: var(--neutral-60);
...
const EditProfileon = styled.div`
  ...
  color: var(--neutral-100);
`;
const SettingsModal1 = styled.div`
  position: absolute;
  top: calc(50% - 400px);
  left: calc(50% - 384px);
...
`;
const Settings: FunctionComponent<SettingsType> = ({ onClose }) => {
  return (
    <SettingsRoot>
      <LeftMenu1>
        <LogoTop>
          <KnowleeLogoWhiteTaglinesvgIcon
            alt=""
            src="/knowlee-logo-white-taglinesvg1.svg"
          />
          <CollapseIcon>
            <CollapseIconChild />
            <CollapseIconItem />
        ...
        <SidebarMenuItemParent>
          <SidebarMenuItem>
            <CollapseIcon1 alt="" src="/dashboard2.svg" />
            <Dashboard>Dashboard</Dashboard>
          </SidebarMenuItem>
          <SidebarMenuItem1>
            <CollapseIcon1 alt="" src="/feed-the-brain2.svg" />
            <FeedTheBrain1>Feed the Brain</FeedTheBrain1>
          </SidebarMenuItem1>
          <SidebarMenuItem>
            <CollapseIcon1 alt="" src="/knowlee-chats2.svg" />
          ...
          <SidebarMenuItem4>
            <CollapseIcon1 alt="" src="/settings2.svg" />
        ...
        <Dashboard1>
          <FrameParent>
            <AppSourceParent>
              ...
              <AppSource>
                <SocialParent>
                  <SocialIcon alt="" src="/social2.svg" />
                  <AppNameWrapper>
                    <AppName>CSV</AppName>
                  </AppNameWrapper>
                </SocialParent>
      ...
      <SettingsModal1>
        <SettingSidebar>
          <SettingsMenu>
            <MenuItem>
              <AddIcon alt="" src="/user-fill2.svg" />
              <Light>Edit profile</Light>
            </MenuItem>
            <MenuItem>
              <AddIcon alt="" src="/lock-fill.svg" />
              <Light>Password</Light>
            </MenuItem>
            <MenuItem>
              <AddIcon alt="" src="/bel.svg" />
              <Light>Notifications</Light>
            </MenuItem>
          </SettingsMenu>
          <MenuItem>
            <AddIcon alt="" src="/settings3.svg" />
            <Light>Preferences Settings</Light>
          </MenuItem>
          <MenuItem4>
            <AddIcon alt="" src="/info.svg" />
            <Light>Action</Light>
          </MenuItem4>
        </SettingSidebar>
        <EditProfileon>
          ...
          <YouCanSpecify>
            You can specify the actions Knowlee should take when a content is
            detected
          </YouCanSpecify>
          <SectionWrapper>
            <Section>
              <Checkbox>
                <Dashboard>Include saving data</Dashboard>
                <CollapseIcon>
                  <CheckboxChild />
              ...
              <Checkbox>
                <Dashboard>Analyzing the data</Dashboard>
                <CollapseIcon>
                  <CheckboxInner />
                </CollapseIcon>
              </Checkbox>
