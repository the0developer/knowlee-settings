...
const SettingSidebar = styled.div`
  ...
  gap: var(--gap-xs);
`;
const PreferencesSettings = styled.b`
  align-self: stretch;
  position: relative;
...
const Language = styled.div`
  ...
  font-weight: 500;
`;
const UserFillIcon1 = styled.img`
  position: relative;
  width: 24px;
  height: 24px;
  overflow: hidden;
...
`;
const Settings1: FunctionComponent<Settings1Type> = ({ onClose }) => {
  return (
    <SettingsRoot>
      <LeftMenu1>
        <LogoTop>
          <KnowleeLogoWhiteTaglinesvgIcon
            alt=""
            src="/knowlee-logo-white-taglinesvg2.svg"
          />
          <CollapseIcon>
            <CollapseIconChild />
            <CollapseIconItem />
        ...
        <SidebarMenuItemParent>
          <SidebarMenuItem>
            <CollapseIcon1 alt="" src="/dashboard3.svg" />
          ...
          <SidebarMenuItem4>
            <CollapseIcon1 alt="" src="/settings4.svg" />
      ...
      <SettingsModal1>
        <SettingSidebar>
          <SettingsMenu>
            <MenuItem>
              <AddIcon alt="" src="/user-fill3.svg" />
              <Light>Edit profile</Light>
            </MenuItem>
            <MenuItem>
              <AddIcon alt="" src="/lock-fill1.svg" />
              <Light>Password</Light>
            </MenuItem>
            <MenuItem>
              <AddIcon alt="" src="/bel1.svg" />
              <Light>Notifications</Light>
            </MenuItem>
            <MenuItem3>
              <AddIcon alt="" src="/settings5.svg" />
              <Light>Preferences Settings</Light>
            </MenuItem3>
          </SettingsMenu>
          <MenuItem>
            <AddIcon alt="" src="/info1.svg" />
            <Light>Action</Light>
          </MenuItem>
        </SettingSidebar>
        <EditProfileon>
          ...
          <EditProfile>
            ...
            <Section1>
              <Name1>
                ...
                <Input>
                  <UserFillParent>
                    <UserFillIcon1 alt="" src="/user-fill4.svg" />
                    <SearchByName>English</SearchByName>
                  </UserFillParent>
                  <CollapseIcon1 alt="" src="/arrow.svg" />
                </Input>
              </Name1>
            </Section1>
          </EditProfile>
