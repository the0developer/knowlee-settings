...
const Password = styled.b`
  ...
  line-height: 56px;
`;
const OldPassword = styled.div`
  align-self: stretch;
  position: relative;
  line-height: 20px;
  font-weight: 500;
`;
const LockFillParent = styled.div`
  display: flex;
  flex-direction: row;
  align-items: center;
  justify-content: flex-start;
...
const Name1 = styled.div`
  ...
  gap: var(--gap-5xs);
`;
const Minimum8Characters = styled.div`
  position: relative;
  line-height: 20px;
  font-weight: 500;
...
`;
const Settings3: FunctionComponent<Settings3Type> = ({ onClose }) => {
  return (
    <SettingsRoot>
      <LeftMenu1>
        <LogoTop>
        ...
        <SidebarMenuItemParent>
          ...
          <SidebarMenuItem4>
            <CollapseIcon1 alt="" src="/settings8.svg" />
      ...
      <SettingsModal1>
        <SettingSidebar>
          <SettingsMenu>
            <MenuItem>
              <AddIcon alt="" src="/user-fill5.svg" />
              <Light>Edit profile</Light>
            </MenuItem>
            <MenuItem1>
              <AddIcon alt="" src="/lock-fill3.svg" />
              <Light>Password</Light>
            </MenuItem1>
            <MenuItem>
              <AddIcon alt="" src="/bel3.svg" />
              <Light>Notifications</Light>
            </MenuItem>
          </SettingsMenu>
          <MenuItem>
            <AddIcon alt="" src="/settings7.svg" />
            <Light>Preferences Settings</Light>
          </MenuItem>
          <MenuItem>
            <AddIcon alt="" src="/info2.svg" />
            <Light>Action</Light>
          </MenuItem>
        </SettingSidebar>
        <EditProfileon>
          ...
          <EditProfile>
            <NameParent>
              <Name1>
                ...
                <Input>
                  <LockFillParent>
                    <CollapseIcon1 alt="" src="/lock-fill4.svg" />
                    <SearchByName>Password</SearchByName>
                  </LockFillParent>
              ...
              <Name1>
                ...
                <Input>
                  <LockFillParent>
                    <CollapseIcon1 alt="" src="/lock-fill4.svg" />
                    <SearchByName>New password</SearchByName>
                  </LockFillParent>
                  <EmailIcon alt="" src="/email1.svg" />
                </Input>
                <Minimum8Characters>Minimum 8 characters</Minimum8Characters>
              </Name1>
              <Name1>
                <OldPassword>Confirm new password</OldPassword>
                <Input>
                  <LockFillParent>
                    <CollapseIcon1 alt="" src="/lock-fill4.svg" />
                    <SearchByName>Confirm new password</SearchByName>
                  </LockFillParent>
                  <EmailIcon alt="" src="/email1.svg" />
                </Input>
                <Minimum8Characters>Minimum 8 characters</Minimum8Characters>
            ...
            <Button>
              <AddIcon6 alt="" src="/add6.svg" />
              <JenniferLinton>Change password</JenniferLinton>
            </Button>
          </EditProfile>
        </EditProfileon>
      </SettingsModal1>
