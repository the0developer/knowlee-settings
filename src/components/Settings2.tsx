...
const Notifications = styled.b`
  ...
  line-height: 56px;
`;
const ToggleButtonChild = styled.div`
  position: relative;
...
`;
const NotificationsParent = styled.div`
  align-self: stretch;
  display: flex;
  flex-direction: row;
  align-items: center;
...
const Section = styled.div`
  ...
  gap: var(--gap-base);
`;
const CheckboxChild1 = styled.div`
  position: absolute;
  top: 1px;
  left: 1px;
  border-radius: var(--br-7xs);
...
`;
const Settings2: FunctionComponent<Settings2Type> = ({ onClose }) => {
  return (
    <SettingsRoot>
      <LeftMenu1>
        <LogoTop>
        ...
        <SidebarMenuItemParent>
          ...
          <SidebarMenuItem4>
            <CollapseIcon1 alt="" src="/settings6.svg" />
      ...
      <SettingsModal1>
        <SettingSidebar>
          <SettingsMenu>
            ...
            <MenuItem>
              <AddIcon alt="" src="/lock-fill2.svg" />
              <Light>Password</Light>
            </MenuItem>
            <MenuItem2>
              <AddIcon alt="" src="/bel2.svg" />
        ...
        <EditProfileon>
          ...
          <EditProfile>
            <Section>
              ...
              <Checkbox>
                <Dashboard>New notifications</Dashboard>
                <CollapseIcon>
                  <CheckboxChild />
              ...
              <Checkbox>
                <Dashboard>Someone invite you to new chat</Dashboard>
                <CollapseIcon>
                  <CheckboxChild />
                  <CheckIcon alt="" src="/check2.svg" />
                </CollapseIcon>
